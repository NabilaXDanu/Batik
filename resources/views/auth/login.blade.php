        ...
        * {
        ...
        @media (min-width: 768px) {
            .auth-image {
                display: block;
                flex: 1;
                background-image: linear-gradient(rgba(79, 70, 229, 0.8), rgba(79, 70, 229, 0.8)), url('https://source.unsplash.com/random/800x1200/?nature');
    ...
    <div class="auth-container">
        <div class="auth-image">
            <div class="auth-image-overlay">
                ...
                <p>Masuk ke akun Anda untuk melanjutkan perjalanan bersama kami dan menikmati semua fitur yang tersedia.</p>
            </div>
        </div>
